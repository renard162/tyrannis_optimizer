...
class Optimizer:
    ...
    def history_columns(self) -> list[str]:
        """Return the column names generated by ``history_generator``."""
    ...
    @property
    def internal_history_columns_(self) -> list[str]:
        """Return the column names generated by ``internal_history_generator_``."""
    ...
    def save_history_csv(
        ...
        columns = (
            self.internal_history_columns_ if internal_state else self.history_columns
        )
        row_generator = (
